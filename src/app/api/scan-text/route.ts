...
const SCAN_SYSTEM_PROMPT = `You are a metabolic health expert. Analyze the provided text of food ingredients.
...
export async function POST(req: Request) {
  try {
    ...
    const { newAchievements } = await updateUserStats(data.score, 'scan-text');
